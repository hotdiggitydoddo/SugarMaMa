...
namespace SugarMaMa.API.Migrations
{
    ...
    partial class Clients
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SugarMaMa.API.DAL.Entities.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<bool>("AppointmentRemindersViaEmail");

                    b.Property<bool>("AppointmentRemindersViaText");
            ...
            modelBuilder.Entity("SugarMaMa.API.DAL.Entities.Shift", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SugarMaMa.API.DAL.Entities.Appointment", b =>
                {
                    b.HasOne("SugarMaMa.API.DAL.Entities.Client", "Client")
                        .WithMany("Appointments")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SugarMaMa.API.DAL.Entities.Shift", "Shift")
                        .WithMany("Appointments")
